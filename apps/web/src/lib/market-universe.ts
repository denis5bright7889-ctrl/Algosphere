...
export const MARKET_UNIVERSE: UniverseCategory[] = [
  {
    ...
    instruments: [
      ...
      // EUR crosses
      fx('EURGBP', 'EUR/GBP', 'crosses', 'EUR/GBP'),
      fx('EURJPY', 'EUR/JPY', 'crosses', 'EUR/JPY'),
      fx('EURCHF', 'EUR/CHF', 'crosses', 'EUR/CHF'),
      fx('EURAUD', 'EUR/AUD', 'crosses', 'EUR/AUD'),
      fx('EURCAD', 'EUR/CAD', 'crosses', 'EUR/CAD'),
      fx('EURNZD', 'EUR/NZD', 'crosses', 'EUR/NZD'),
      // GBP crosses
      fx('GBPJPY', 'GBP/JPY', 'crosses', 'GBP/JPY'),
      fx('GBPCHF', 'GBP/CHF', 'crosses', 'GBP/CHF'),
      fx('GBPAUD', 'GBP/AUD', 'crosses', 'GBP/AUD'),
      fx('GBPCAD', 'GBP/CAD', 'crosses', 'GBP/CAD'),
      fx('GBPNZD', 'GBP/NZD', 'crosses', 'GBP/NZD'),
      // JPY & commodity-dollar crosses
      fx('AUDJPY', 'AUD/JPY', 'crosses', 'AUD/JPY'),
      fx('CADJPY', 'CAD/JPY', 'crosses', 'CAD/JPY'),
      fx('CHFJPY', 'CHF/JPY', 'crosses', 'CHF/JPY'),
      fx('NZDJPY', 'NZD/JPY', 'crosses', 'NZD/JPY'),
      fx('AUDNZD', 'AUD/NZD', 'crosses', 'AUD/NZD'),
      fx('AUDCAD', 'AUD/CAD', 'crosses', 'AUD/CAD'),
      // Exotics
      fx('USDSEK', 'USD/SEK', 'exotics', 'USD/SEK'),
      fx('USDNOK', 'USD/NOK', 'exotics', 'USD/NOK'),
      fx('USDSGD', 'USD/SGD', 'exotics', 'USD/SGD'),
      fx('USDMXN', 'USD/MXN', 'exotics', 'USD/MXN'),
      fx('USDZAR', 'USD/ZAR', 'exotics', 'USD/ZAR'),
      fx('USDTRY', 'USD/TRY', 'exotics', 'USD/TRY'),
    ],
  },
  {
    assetClass: 'gold',
  ...
  },
  {
    ...
    instruments: [
      ...
      cmd('SOYBEAN', 'Soybean',   'agriculture', null),
      cmd('SUGAR',   'Sugar',     'agriculture', null),
      cmd('COFFEE',  'Coffee',    'agriculture', null),
      cmd('COCOA',   'Cocoa',     'agriculture', null),
